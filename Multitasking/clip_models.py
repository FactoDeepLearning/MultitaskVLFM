...
from OPENCLIP.transformer import LayerNorm as OPENLayerNorm
...
def convert_weights(model: nn.Module):
    ...
    def _convert_weights_to_fp16(l):
        if type(l) is not LayerNorm and isinstance(l, (nn.Conv1d, nn.Conv2d, nn.Linear, OPENLayerNorm, TorchLayerNorm)):
...
def build_model(state_dict: dict, params: dict):
