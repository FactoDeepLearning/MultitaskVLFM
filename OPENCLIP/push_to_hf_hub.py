...
def push_to_hf_hub(
    ...
    if not isinstance(tokenizer, HFTokenizer):
        # default Multitasking tokenizers use https://huggingface.co/openai/clip-vit-large-patch14
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pretrained", type=str,
        help="Use a pretrained Multitasking model weights with the specified tag or file path.",
    )
    parser.add_argument(
        "--repo-id", type=str,
